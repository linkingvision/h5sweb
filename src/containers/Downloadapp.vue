<template>
    <div class="download">
        <!-- 头部 -->
        <div class="dow_title">
            <img src="../assets/imgs/logo.png" alt="home" class="dark-logo" />
        </div>
        <!-- 头部轮播 -->
        <div class="title_img">
    ...
    data () {
        return {
            ...
            content:[{
                    ...
                    connode:[{
                        name:"插件",
                        img:require("../assets/imgs/app/dow_plugin.png"),
                    ...
                    connode:[{
                        name:"H5S视频平台",
                        img:require("../assets/imgs/app/dow_app.png"),
                        Introduction:"Android APP(代码开放)",
                        qrcodenone:[{
                            name:"Android",
                            img:require("../assets/imgs/app/Android.png")
                        }]
                    }]
                }
            ]
...
.title_back{
    width: 50%;
    background: url('../assets/imgs/app/dow_back.png') no-repeat 180px;
    background-size: 70%;
    height: 100%;
}
.title_but{
...
.Anchor_logo{
    width: 100%;
    background: url('../assets/imgs/app/dow_h5svideo.png') no-repeat;
    background-size: 30%;
    height: 40px;
}
.Anchor_heng{
